            ...
            <div class="mb-3">
                ...
                @if ($buku->filepath)
                    <img class="object-cover object-center"
                        src="{{ $buku->filepath }}" style="width: 200px; height: 200px;"><br>
                @endif
                <input type="file" class="form-control" id="thumbnail" name="thumbnail" value="{{ $buku->filepath }}"><br> 
            </div>
        ...
        <div>
            ...
            <div class="d-flex flex-wrap">
                @foreach ($buku->galeri()->get() as $item)
                    <div class='m-3 d-flex flex-column align-items-center' style="flex: 0 0 340px; max-width: 340px; height: 100%;">
                        ...
                        <form action="{{ route('buku.delete_galeri', $item->id) }}" method="POST">
                            @csrf
                            <button type="submit" class="btn btn-outline-danger" onclick="return confirm('Yakin mau dihapus?')">
                                Hapus
                            </button>
                        </form>
                    </div>
